...
! function (e, i) {
    ...
    function i(u, h, d) {
        (d = d || e || t.jQuery) && (h.prototype.option || (h.prototype.option = function (t) {
            ...
            var e, o, n, s, r, a;
            return "string" == typeof t ? (e = l.call(arguments, 1), n = e, r = "$()." + u + '("' + (o = t) + '")', (e = this).each(function (t, e) {
                var i, e = d.data(e, u);
    ...
    function (t, e) {
        ...
        function v(t) {
            if (x || (x = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (h = document.body || document.documentElement).appendChild(d), s = g(d), _ = 200 == Math.round(y(s.width)), v.isBoxSizeOuter = _, h.removeChild(d)), (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
                var e = g(t);
                if ("none" == e.display) {
                    for (var i = {
                        width: 0,
    ...
    function (e, i) {
        ...
        return u.htmlInit = function (r, a) {
            u.docReady(function () {
                var t = u.toDashed(a),
                    o = "data-" + t,
        ...
        var o = document.documentElement.style,
            ...
            a = (t.constructor = i, t._create = function () {
                ...
                var t = getComputedStyle(this.element),
                    ...
                    n = parseFloat(o),
                    s = parseFloat(t),
                    r = this.layout.size; - 1 != o.indexOf("%") && (n = n / 100 * r.width), -1 != t.indexOf("%") && (s = s / 100 * r.height), n = isNaN(n) ? 0 : n, s = isNaN(s) ? 0 : s, n -= e ? r.paddingLeft : r.paddingRight, s -= i ? r.paddingTop : r.paddingBottom, this.position.x = n, this.position.y = s
                ...
                this.setPosition(t, e), n && !this.isTransitioning ? this.layoutPosition() : ((n = {}).transform = this.getTranslate(t - i, e - o), this.transition({
                    to: n,
                    onTransitionEnd: {
    ...
    function (n, s) {
        ...
        function r(t, e) {
            ...
            i ? (this.element = i, h && (this.$element = h(this.element)), this.options = o.extend({}, this.constructor.defaults), this.option(e), e = ++d, this.element.outlayerGUID = e, (l[e] = this)._create(), this._getOption("initLayout") && this.layout()) : u && u.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
        }
        ...
        var u = t.console,
            ...
            d = 0,
            l = {},
            c = (r.namespace = "outlayer", r.Item = s, r.defaults = {
                containerStyle: {
                    position: "relative"
                },
                initLayout: !0,
            ...
            m = (o.extend(c, e.prototype), c.option = function (t) {
                ...
                return null == e ? void (this.stagger = 0) : (this.stagger = "number" == typeof (e = e) ? e : (t = (e = e.match(/(^\d*\.?\d*)(\w*)/)) && e[1], e = e && e[2], t.length ? (t = parseFloat(t)) * (m[e] || 1) : 0), this.stagger)
                ...
                this.resize()
            }, o.debounceMethod(r, "onresize", 100), c.resize = function () {
                ...
                var i = a(r);
                return i.defaults = o.extend({}, r.defaults), o.extend(i.defaults, e), i.compatOptions = o.extend({}, r.compatOptions), i.namespace = t, i.data = r.data, i.Item = a(s), o.htmlInit(i, t), h && h.bridget && h.bridget(t, i), i
            }, {
                ms: 1,
                s: 1e3
            });
    ...
    function (t, e) {
        ...
        return e._resetLayout = function () {
            ...
            t.getSize();
            for (var e = t.size.outerWidth % this.columnWidth, e = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), e = Math.min(e, this.cols), i = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](e, t), o = {
                x: this.columnWidth * i.col,
                y: i.y
            }, n = i.y + t.size.outerHeight, s = e + i.col, r = i.col; r < s; r++) this.colYs[r] = n;
            return o
    ...
    function (r, a) {
        ...
        var a = t.jQuery,
            ...
            d = (t._create = function () {
                ...
                var e, i, o, n, s, r;
                return "string" != typeof t ? t : (i = (i = (e = (t = u(t).split(" "))[0]).match(/^\[(.+)\]$/)) && i[1], r = e, o = (s = i) ? function (t) {
                    return t.getAttribute(s)
                } : function (t) {
                    t = t.querySelector(r);
                    return t && t.textContent
                }, (n = h.sortDataParsers[t[1]]) ? function (t) {
                    return t && n(o(t))
                } : function (t) {
                    return t && o(t)
                })
